...
//TODO: disable view for local player
...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    /// </summary>
    public class NetworkedRiggedHandVisualizer : MonoBehaviourPun, IMixedRealityHandJointHandler
    {
        /// <inheritdoc/>
        ...
        private void Start()
        {
            ...
            {
                // don't show hands on local player
                // enable on remote
        ...
        {
            // Only receive joint data for local player
            if (photonView.IsMine)
            {
        ...
        void IMixedRealityHandJointHandler.OnHandJointsUpdated(InputEventData<IDictionary<TrackedHandJoint, MixedRealityPose>> eventData)
        {
            if (!photonView.IsMine)
            {
                // Remote player: get joint data from network
                Debug.LogError("Remote player " + this.photonView.ViewID + " is subscribed to local joint updates.");
                return;
            }
            ...
            /*
            if (eventData.InputSource.SourceId
                != Controller.InputSource.SourceId)
            {
                return;
            }
            */
            ...
            // Always disable joint rendering
            ...
            */
            ...
            // Always run! We want to render on the remotes
            bool renderHandmesh = true;
            if (renderHandmesh)
            {
